...
3. To enter **Kernel Mode (Ring 0)**, you must perform a **System Call**. (Another Way to use **Kernel Mode (Ring 0)** is by writing **Linux Kernel Modules** in C. </br> *FYI: In Windows you usually program a **driver** in C to use Kernel Mode (Ring 0)*)
